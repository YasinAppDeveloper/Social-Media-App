...
class ReelCommentAdapter(context: Context,listOfComments:List<Reel_Comment>
                     ): RecyclerView.Adapter<ReelCommentAdapter.ViewHolder>() {

    private var firebaseUser: FirebaseUser? = null
    private val commentsList = mutableListOf<Reel_Comment>()
    ...
    inner class ViewHolder(@NonNull itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            timeStamp = itemView.findViewById(R.id.commentsReelTimePost)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        publisherInfo(holder.profileImage, holder.publisher, comment.getPublisher())
         val timeConvert = getTime(commentsList[position].getTime())
         holder.timeStamp.text = timeConvert
